...
public class DBManager implements Serializable {
    ...
    public boolean addPoint(Dot dot) {
        ...
        try {
            Connection connection = DriverManager.getConnection("jdbc:postgresql://pg:5432/studs", "s343390", "");
    ...
    public ArrayList<Dot> getPoints() {
        ...
        try {
            ...
            connection = DriverManager.getConnection("jdbc:postgresql://pg:5432/studs", "s3343390", "KFJg@3343");
    ...
    public void clearTable(){
        ...
        try {
            ArrayList<Dot> ans = new ArrayList<Dot>();
            connection = DriverManager.getConnection("jdbc:postgresql://pg:5432/studs", "s343390", "KFJg@3343");
